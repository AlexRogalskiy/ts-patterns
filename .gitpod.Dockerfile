...
LABEL io.nullables.proverbs.name="typescript-patterns"
LABEL io.nullables.proverbs.description="TypeScript patterns"
LABEL io.nullables.proverbs.url="https://sensiblemetrics.io/"
LABEL io.nullables.proverbs.vcs-ref=$VCS_REF
LABEL io.nullables.proverbs.vcs-url="https://github.com/AlexRogalskiy/typescript-patterns"
LABEL io.nullables.proverbs.vendor="Sensiblemetrics.io"
